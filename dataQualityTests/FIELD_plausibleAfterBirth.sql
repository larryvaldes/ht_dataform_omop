    ...
    (
        ...
        where cdmtable.condition_era_end_date is not null and 
            if(safe_cast(cdmtable.condition_era_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_era_end_date  as string)),safe_cast(cdmtable.condition_era_end_date  as date)) < coalesce(
                ...
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
                        '01'
                    ),
                    coalesce(
                        substr(concat('0', cast(p.day_of_birth as string)),-2),
                        '01'
                    )
                ))
            )
...
(
    ...
    (
        ...
        where cdmtable.condition_era_start_date is not null and 
            if(safe_cast(cdmtable.condition_era_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_era_start_date  as string)),safe_cast(cdmtable.condition_era_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.condition_end_date is not null and 
            if(safe_cast(cdmtable.condition_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_end_date  as string)),safe_cast(cdmtable.condition_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.condition_end_datetime is not null and 
            if(safe_cast(cdmtable.condition_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_end_datetime  as string)),safe_cast(cdmtable.condition_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.condition_start_date is not null and 
            if(safe_cast(cdmtable.condition_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_start_date  as string)),safe_cast(cdmtable.condition_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.condition_start_datetime is not null and 
            if(safe_cast(cdmtable.condition_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.condition_start_datetime  as string)),safe_cast(cdmtable.condition_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.death_date is not null and 
            if(safe_cast(cdmtable.death_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.death_date  as string)),safe_cast(cdmtable.death_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.death_datetime is not null and 
            if(safe_cast(cdmtable.death_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.death_datetime  as string)),safe_cast(cdmtable.death_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.device_exposure_end_date is not null and 
            if(safe_cast(cdmtable.device_exposure_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.device_exposure_end_date  as string)),safe_cast(cdmtable.device_exposure_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.device_exposure_end_datetime is not null and 
            if(safe_cast(cdmtable.device_exposure_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.device_exposure_end_datetime  as string)),safe_cast(cdmtable.device_exposure_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.device_exposure_start_date is not null and 
            if(safe_cast(cdmtable.device_exposure_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.device_exposure_start_date  as string)),safe_cast(cdmtable.device_exposure_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.device_exposure_start_datetime is not null and 
            if(safe_cast(cdmtable.device_exposure_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.device_exposure_start_datetime  as string)),safe_cast(cdmtable.device_exposure_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.dose_era_end_date is not null and 
            if(safe_cast(cdmtable.dose_era_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.dose_era_end_date  as string)),safe_cast(cdmtable.dose_era_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.dose_era_start_date is not null and 
            if(safe_cast(cdmtable.dose_era_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.dose_era_start_date  as string)),safe_cast(cdmtable.dose_era_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_era_end_date is not null and 
            if(safe_cast(cdmtable.drug_era_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_era_end_date  as string)),safe_cast(cdmtable.drug_era_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_era_start_date is not null and 
            if(safe_cast(cdmtable.drug_era_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_era_start_date  as string)),safe_cast(cdmtable.drug_era_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_exposure_end_date is not null and 
            if(safe_cast(cdmtable.drug_exposure_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_exposure_end_date  as string)),safe_cast(cdmtable.drug_exposure_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_exposure_end_datetime is not null and 
            if(safe_cast(cdmtable.drug_exposure_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_exposure_end_datetime  as string)),safe_cast(cdmtable.drug_exposure_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_exposure_start_date is not null and 
            if(safe_cast(cdmtable.drug_exposure_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_exposure_start_date  as string)),safe_cast(cdmtable.drug_exposure_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.drug_exposure_start_datetime is not null and 
            if(safe_cast(cdmtable.drug_exposure_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.drug_exposure_start_datetime  as string)),safe_cast(cdmtable.drug_exposure_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.verbatim_end_date is not null and 
            if(safe_cast(cdmtable.verbatim_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.verbatim_end_date  as string)),safe_cast(cdmtable.verbatim_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.episode_end_date is not null and 
            if(safe_cast(cdmtable.episode_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.episode_end_date  as string)),safe_cast(cdmtable.episode_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.episode_end_datetime is not null and 
            if(safe_cast(cdmtable.episode_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.episode_end_datetime  as string)),safe_cast(cdmtable.episode_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.episode_start_date is not null and 
            if(safe_cast(cdmtable.episode_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.episode_start_date  as string)),safe_cast(cdmtable.episode_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.episode_start_datetime is not null and 
            if(safe_cast(cdmtable.episode_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.episode_start_datetime  as string)),safe_cast(cdmtable.episode_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.measurement_date is not null and 
            if(safe_cast(cdmtable.measurement_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.measurement_date  as string)),safe_cast(cdmtable.measurement_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.measurement_datetime is not null and 
            if(safe_cast(cdmtable.measurement_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.measurement_datetime  as string)),safe_cast(cdmtable.measurement_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.note_date is not null and 
            if(safe_cast(cdmtable.note_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.note_date  as string)),safe_cast(cdmtable.note_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.note_datetime is not null and 
            if(safe_cast(cdmtable.note_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.note_datetime  as string)),safe_cast(cdmtable.note_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.observation_date is not null and 
            if(safe_cast(cdmtable.observation_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.observation_date  as string)),safe_cast(cdmtable.observation_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.observation_datetime is not null and 
            if(safe_cast(cdmtable.observation_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.observation_datetime  as string)),safe_cast(cdmtable.observation_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.observation_period_end_date is not null and 
            if(safe_cast(cdmtable.observation_period_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.observation_period_end_date  as string)),safe_cast(cdmtable.observation_period_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.observation_period_start_date is not null and 
            if(safe_cast(cdmtable.observation_period_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.observation_period_start_date  as string)),safe_cast(cdmtable.observation_period_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.payer_plan_period_end_date is not null and 
            if(safe_cast(cdmtable.payer_plan_period_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.payer_plan_period_end_date  as string)),safe_cast(cdmtable.payer_plan_period_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.payer_plan_period_start_date is not null and 
            if(safe_cast(cdmtable.payer_plan_period_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.payer_plan_period_start_date  as string)),safe_cast(cdmtable.payer_plan_period_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.procedure_date is not null and 
            if(safe_cast(cdmtable.procedure_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.procedure_date  as string)),safe_cast(cdmtable.procedure_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.procedure_datetime is not null and 
            if(safe_cast(cdmtable.procedure_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.procedure_datetime  as string)),safe_cast(cdmtable.procedure_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.procedure_end_date is not null and 
            if(safe_cast(cdmtable.procedure_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.procedure_end_date  as string)),safe_cast(cdmtable.procedure_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.procedure_end_datetime is not null and 
            if(safe_cast(cdmtable.procedure_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.procedure_end_datetime  as string)),safe_cast(cdmtable.procedure_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.specimen_date is not null and 
            if(safe_cast(cdmtable.specimen_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.specimen_date  as string)),safe_cast(cdmtable.specimen_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.specimen_datetime is not null and 
            if(safe_cast(cdmtable.specimen_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.specimen_datetime  as string)),safe_cast(cdmtable.specimen_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_detail_end_date is not null and 
            if(safe_cast(cdmtable.visit_detail_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_detail_end_date  as string)),safe_cast(cdmtable.visit_detail_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_detail_end_datetime is not null and 
            if(safe_cast(cdmtable.visit_detail_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_detail_end_datetime  as string)),safe_cast(cdmtable.visit_detail_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_detail_start_date is not null and 
            if(safe_cast(cdmtable.visit_detail_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_detail_start_date  as string)),safe_cast(cdmtable.visit_detail_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_detail_start_datetime is not null and 
            if(safe_cast(cdmtable.visit_detail_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_detail_start_datetime  as string)),safe_cast(cdmtable.visit_detail_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_end_date is not null and 
            if(safe_cast(cdmtable.visit_end_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_end_date  as string)),safe_cast(cdmtable.visit_end_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_end_datetime is not null and 
            if(safe_cast(cdmtable.visit_end_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_end_datetime  as string)),safe_cast(cdmtable.visit_end_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_start_date is not null and 
            if(safe_cast(cdmtable.visit_start_date  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_start_date  as string)),safe_cast(cdmtable.visit_start_date  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
...
(
    ...
    (
        ...
        where cdmtable.visit_start_datetime is not null and 
            if(safe_cast(cdmtable.visit_start_datetime  as date) is null,parse_date('%Y%m%d', cast(cdmtable.visit_start_datetime  as string)),safe_cast(cdmtable.visit_start_datetime  as date)) < coalesce(
                if(safe_cast(p.birth_datetime  as date) is null,parse_date('%Y%m%d', cast(p.birth_datetime  as string)),safe_cast(p.birth_datetime  as date)), 
                parse_date('%Y%m%d', concat(p.year_of_birth,
                    coalesce(
                        substr(concat('0', cast(p.month_of_birth as string)),-2),
